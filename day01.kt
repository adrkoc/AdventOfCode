...
fun secondStar(file: String): Int {
    val input: InputStream = File(file).inputStream()
    val lines: MutableList<String> = mutableListOf()
    input.bufferedReader().forEachLine { line -> lines.add(line) }
...
fun main(args: Array<String>) {
    println(firstStar("src/main/kotlin/day01_input01.txt")) // 54644
    println(secondStar("src/main/kotlin/day01_input01.txt")) // 53348
}